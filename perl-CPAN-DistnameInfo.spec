...
Requires: perl-CPAN-DistnameInfo-man
...
%package man
Summary: man components for the perl-CPAN-DistnameInfo package.
Group: Default

%description man
man components for the perl-CPAN-DistnameInfo package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/CPAN/DistnameInfo.pm
